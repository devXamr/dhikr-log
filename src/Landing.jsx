...
export default function Landing({isDarkOn, setDark}){
    ...
    <div className='h-screen w-screen dark:bg-black'>
        ...
        <button onClick={simpleDirect} className='block pt-4 pr-6 pl-6 pb-4 hover:w-52 border-white border-4 hover:shadow-md hover:border-green-800 text-center mt-7 w-48 mr-auto ml-auto rounded-xl bg-gray-200 hover:cursor-pointer duration-200 dark:bg-gray-600 dark:text-white dark:font-bold dark:border-gray-700'>Simple Counter</button>
        <button onClick={tasbihDirect} className='block pt-4 pr-8 pl-8 pb-4 hover:shadow-md text-center mt-7 w-48 mr-auto ml-auto rounded-xl bg-gray-200 hover:w-52 border-4 border-white hover:border-green-800 hover:cursor-pointer duration-200 dark:bg-gray-600 dark:text-white dark:font-bold dark:border-gray-700'>Tasbih</button>
    </div>
    </div>
}