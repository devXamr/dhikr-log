...
export default function Landing({ isDarkOn, setDark }) {
  ...
  return (
    <div className={`${isDarkOn && "dark"} font-cabinet`}>
      {/*<DarkModeToggleButton boolVal={isDarkOn} setterFunc={setDark}/> */}
      <div className="h-screen w-screen dark:bg-black relative ">
        <div className="md:text-[#efdecd] text-center pt-72 font-semibold text-[#9F8170] text-6xl dark:text-[#9F8170]">
          Ramadan Kareem
        </div>
        <button
          onClick={simpleDirect}
        ...
        >
          <div className="mr-4 text-lg text-[#9F8170] font-bold">
            Open Counter
          </div>
          <BsArrowRight className="mt-0.5 font-black text-2xl text-[#9F8170]" />
        </button>

        <div className="text-center text-lg mt-10 md:text-xl">
          إِنَّ ٱللَّهَ يُحِبُّ ٱلتَّوَّٲبِينَ وَيُحِبُّ ٱلۡمُتَطَهِّرِينَ{" "}
        </div>
        <div className="text-center text-lg max-w-56 mx-auto mt-4">
          "Verily, Allah loves those who repent and those who purify
          themselves." [Al-Qur'an 2:222]
        </div>
      </div>
      ...
      <motion.div
        ...
        className="w-screen fixed top-0 -z-20"
      >
      ...
      <motion.img
        ...
        src={lantern}
        className="md:hidden fixed z-50 top-[135px] h-[70px]"
      />
      <motion.img
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 100, y: 0 }}
        ...
        className="md:hidden fixed z-50 top-[135px] right-0 h-[70px]"
      />
      <motion.img
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 100, y: 0 }}
        ...
        className="md:hidden fixed z-50 top-[165px] right-[50%] h-[70px]"
      />
      <motion.img
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 100, y: 0 }}
        ...
        src={sparkles}
        className="md:hidden fixed z-50 top-[135px] left-12"
      />
      <motion.img
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 100, y: 0 }}
        ...
        src={sparkles}
        className="md:hidden fixed z-50 top-[138px]  right-11"
      />
      <motion.img
        initial={{ opacity: 0, y: -10 }}
        animate={{ opacity: 100, y: 0 }}
        ...
        src={sparkles}
        className="md:hidden fixed z-50 top-[165px] right-[50%]"
      />
    </div>
  );
}
