    ...
    return (
        <div className={`${isDarkOn && 'dark'} dark:bg-black pb-16`}>
            ...
            <div className='w-screen h-screen z-10 dark:bg-black' onClick={updateTasbih}>
                ...
                <button className='mt-80 mx-auto w-fit block        '>
                ...
                {tasbih > 0 && <button
                    className='block font-bold text-center bg-slate-200 text-black w-max mt-11 mr-auto ml-auto pr-3 pl-3 pt-1 pb-1 rounded-lg text-xl border-4 border-white hover:border-green-800 hover:cursor-pointer duration-200 hover:px-5 dark:text-white dark:bg-gray-600 dark:border-gray-700' onClick={changeSave}>Save</button>}


                <button onClick={changeLog} className='block font-bold text-center bg-slate-200 text-black w-max mt-4 mr-auto ml-auto pr-3 pl-3 pt-1 pb-1 rounded-lg text-xl mb-8 border-4 border-white hover:border-green-800 hover:cursor-pointer duration-200 hover:px-5 dark:text-white dark:bg-gray-600 dark:border-gray-700'>{isLogClicked? 'Close' : 'Show Log'}</button>
                { isLogClicked &&
